...
namespace Keep.Widgets {
    ...
    public class KeepHeaderBar : Gtk.HeaderBar {
        ...
        private void setup_ui () {
            ...
            sidebar_toggle_img_hide = new Image.from_icon_name ("pane-hide-symbolic", IconSize.LARGE_TOOLBAR);
            sidebar_toggle_img_show = new Image.from_icon_name ("pane-show-symbolic", IconSize.LARGE_TOOLBAR);
            ...
            this.pack_start (sidebar_toggle_button);

            //new note button
            new_note_button = new Button.from_icon_name ("document-new", IconSize.LARGE_TOOLBAR);
            new_note_button.margin_end = 3;
            new_note_button.set_tooltip_text (_("New Note"));
            this.pack_start (new_note_button);

            //delete note button
            delete_note_button = new Button.from_icon_name ("user-trash", IconSize.LARGE_TOOLBAR);
            delete_note_button.margin_end = 3;
            delete_note_button.set_tooltip_text (_("Delete Note"));
            this.pack_start (delete_note_button);
